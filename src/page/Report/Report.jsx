        ...
        <div className={style.container}>
            ...
            <div className={style.description__container}>
                ...
                <div className={style.description__text}>
                    <a href={doc_1} target='_blank' rel='noreferrer'>Download Agenda
                        <i class="fa-solid fa-download" style={{ color: "#ffffff" }}></i>
                    </a>
                    <a href={doc_2} target='_blank' rel='noreferrer'>Download Presentation
                        <i class="fa-solid fa-download" style={{ color: "#ffffff" }}></i></a>
                    <a href={doc_3} target='_blank' rel='noreferrer'>Download Press Release
                        <i class="fa-solid fa-download" style={{ color: "#ffffff" }}></i></a>
                    <a href={doc_4} target='_blank' rel='noreferrer'>Download Transcript
                        <i class="fa-solid fa-download" style={{ color: "#ffffff" }}></i></a>
                </div>
            </div>
        </div>
